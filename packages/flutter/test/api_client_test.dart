...
void main() {
  ...
  group('PasskeyApiClient — recuperação biométrica (SPEC-passkey-0002)', () {
    test(
      'beginBiometricRecoveryRegistration envia o body e parseia o DTO',
      () async {
        late http.Request captured;
        final mock = MockClient((req) async {
          captured = req;
    ...
    test(
      'finishRegistration inclui recoveryGrantId quando informado',
      () async {
        late http.Request captured;
        final mock = MockClient((req) async {
          captured = req;
    ...
    test(
      'finishRegistration omite recoveryGrantId quando ausente (default)',
      () async {
        late http.Request captured;
        final mock = MockClient((req) async {
          captured = req;
